...
public class IPSeeker {
	...
	private final static Logger log = Logger.getLogger(IPSeeker.class);
	...
	public IPSeeker() {
		this.INSTALL_DIR = this.getClass().getResource("").toString().replaceAll("file:/", "").replaceAll("%20", " ");
		buf = new byte[100];
		b4 = new byte[4];
		b3 = new byte[3];
		try {
	 ...
	 * @return IPLocation结构
	 */
	public IPLocation getIPLocation(byte[] ip, IPLocation info) {
		loc = info;
