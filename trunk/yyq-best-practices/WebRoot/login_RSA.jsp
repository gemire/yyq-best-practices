...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function ok(){
				setMaxDigits(130);
				var key=new RSAKeyPair("10001","","<%=RSAUtil.getPublicKey()%>");
				$("#password2").val(encryptedString(key,"<%=request.getRemoteAddr()%>@<%=DateUtil.nowTime()%>@"+p));
				$("#charDiv").hide();
				isDivShow=false;
				$("#captchafield").focus();
			}
...
.charTd{
	...
	<body onload="document.f.j_username.focus();">
		...
		<table>
			...
			<tr><td>验证码</td><td><img src="SimpleCaptcha.jpg" onclick="this.src='SimpleCaptcha.jpg'"><br><input type="text" name="captchafield" id="captchafield"></td></tr>
		...
		<input id="j_password" type="hidden" name="j_password" value="1">
		</form>
